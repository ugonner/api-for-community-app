            ...
            <div class="container-fluid"  style="background: black !important;">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right" >
                    ...
                    <ul class="nav navbar-nav" >
                        ...
                        <li><a class="btn btn-lg " href="/api/gallery/gallery.html.php">Gallery</a></li>
                        <li><a class="btn btn-sm " href="/api/advert/placead.html.php">Ad</a></li>
                        <li><a class="btn btn-sm " href="#contactdiv">Contact</a></li>

                        <li class="has-child"><a class="btn" href="">About</a>
                            <ul class="submenu">
                                <li class="submenu-item"><a class="btn btn-primary" href="/api/about.html.php">
                                        History, Mission & Goals
                                </a></li>
                                <li class="submenu-item"><a class="btn btn-primary" href="/api/aims.html.php">
                                        Aims, Achievements & Challenges
                                </a></li>
                            </ul>
                        </li>

                        <li class="has-child"><a href="#" class="btn ">Welfare Programs And Updates</a>
                            <ul class="submenu">
                                <?php foreach($head_clusters as $hcl):?>
                                    <li class="submenu-item">
                                        <a class="btn btn-sm" href="/api/cluster/?getcluster&clusterid=<?php echo $hcl["clusterid"]; ?>">
                                            <?php echo $hcl["clustername"]; ?>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        ...
                        <li class="has-child"><a href="#" class="btn">News</a>
                            <ul class="submenu">
                                <?php foreach($headcategories as $headcategory):?>
                                    <li class="submenu-item">
                                        <a class="btn btn-sm" href="/api/article/?gabc&cid=<?php echo $headcategory["id"]; ?>&categoryname=<?php echo $headcategory["name"]; ?>">
                        ...
                        <li class="has-child"><a href="#" class="btn ">Updates On Priority Area </a>
                            <ul class="submenu">
                                <?php foreach($headfocalareas as $fa):?>
                                    <li class="submenu-item">
                                        <a class="btn btn-sm" href="/api/article/?gfa&faid=<?php echo $fa[0]; ?>">
                                            <?php echo $fa[1]; ?>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                        ...
                        <li class="has-child"><a href="#" class="btn btn-lg ">Members </a>
                            <ul class="submenu">
                        ...
                        <?php if(!isset($_SESSION["userid"])):?>
                            <li ><a class="btn btn-danger" href="/api/user/registration.html.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
                            <li ><a class="btn btn-danger" href="/api/user/index.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>

                        <?php else: ?>
                            <li ><a class="btn btn-danger" href="/api/user/index.php?logout"><span class="glyphicon glyphicon-log-in"></span> Log Out</a></li>
                        <?php endif;?>
                    </ul>
                </div> <!-- /#navbar -->
...
<!--fixed menu button-->
<div class="btn btn-lg btn-secondary side-nav-toggler"  style="background: gray !important;" data-target="#side-nav-1" data-toggle="collapse">
